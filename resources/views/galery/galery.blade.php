            ...
            <div class="col-md-6">
                ...
                <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <strong class="d-inline-block mb-2 text-dark"></strong>
                        <h3 class="mb-0">
                            <a class="text-dark text-center" href="{{url('/detail/galery/'.$gl->id)}}">Galery {{$gl->name}}</a>
                        </h3>
                        <div class="mb-1 text-muted"></div>
                        <p class="card-text mb-auto"></p>
                        <a style="margin-bottom:20px;" href="{{url('/detail/galery/'.$gl->id)}}">View Gallery</a>
                    </div>
                </div>
